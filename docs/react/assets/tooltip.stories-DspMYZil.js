...
}`,...(f=(y=r.parameters)==null?void 0:y.docs)==null?void 0:f.source}}};var j,b,C;i.parameters={...i.parameters,docs:{...(j=i.parameters)==null?void 0:j.docs,source:{originalSource:`() => {
  const [open, setOpen] = useState(true);
  return <div style={{
    display: "flex",
    alignItems: "center",
...
}`,...(C=(b=i.parameters)==null?void 0:b.docs)==null?void 0:C.source}}};var v,S,O;s.parameters={...s.parameters,docs:{...(v=s.parameters)==null?void 0:v.docs,source:{originalSource:`() => {
  const [open, setOpen] = useState(true);
  return <div style={{
    display: "flex",
    alignItems: "center",
