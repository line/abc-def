...
<template>
  <Example title="OTP Input Fields">
    <FieldGroup>
      <Field>
        <FieldLabel html-for="otp-basic"> Verification Code </FieldLabel>
      ...
      <Field>
        <FieldLabel html-for="otp-with-desc"> Enter OTP </FieldLabel>
        <InputOTP id="otp-with-desc" v-model="value" :maxlength="6">
          <InputOTPGroup>
            <InputOTPSlot :index="0" />
            <InputOTPSlot :index="1" />
            <InputOTPSlot :index="2" />
      ...
      <Field>
        <FieldLabel html-for="otp-pin"> PIN Code </FieldLabel>
        <InputOTP
          id="otp-pin"
          v-model="pinValue"
          :maxlength="4"
      ...
      <Field data-invalid>
        <FieldLabel html-for="otp-invalid"> Invalid OTP </FieldLabel>
      ...
      <Field data-disabled>
        <FieldLabel html-for="otp-disabled-field"> Disabled OTP </FieldLabel>
