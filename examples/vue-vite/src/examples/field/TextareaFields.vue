...
<template>
  <Example title="Textarea Fields">
    <FieldGroup>
      <Field>
        <FieldLabel html-for="textarea-basic"> Basic Textarea </FieldLabel>
        <Textarea id="textarea-basic" placeholder="Enter your message" />
      </Field>
      <Field>
        <FieldLabel html-for="textarea-comments"> Comments </FieldLabel>
        <Textarea
      ...
      <Field>
        <FieldLabel html-for="textarea-bio"> Bio </FieldLabel>
        <FieldDescription>
      ...
      <Field>
        <FieldLabel html-for="textarea-desc-after"> Message </FieldLabel>
      ...
      <Field data-invalid>
        <FieldLabel html-for="textarea-invalid"> Invalid Textarea </FieldLabel>
        <Textarea
          id="textarea-invalid"
