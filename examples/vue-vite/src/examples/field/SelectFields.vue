...
<template>
  <Example title="Select Fields">
    <FieldGroup>
      <Field>
        <FieldLabel html-for="select-basic"> Basic Select </FieldLabel>
        <Select>
      ...
      <Field>
        <FieldLabel html-for="select-country"> Country </FieldLabel>
        <Select>
      ...
      <Field>
        <FieldLabel html-for="select-timezone"> Timezone </FieldLabel>
        <FieldDescription>
      ...
      <Field data-invalid>
        <FieldLabel html-for="select-invalid"> Invalid Select </FieldLabel>
        <Select>
