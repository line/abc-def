  ...
  <Example title="Switch Fields">
    <FieldGroup>
      <Field orientation="horizontal">
        <FieldContent>
          <FieldLabel html-for="switch-airplane"> Airplane Mode </FieldLabel>
          <FieldDescription>
      ...
      <Field orientation="horizontal">
        <FieldLabel html-for="switch-dark"> Dark Mode </FieldLabel>
      ...
      <Field data-invalid orientation="horizontal">
        <FieldContent>
          <FieldLabel html-for="switch-invalid"> Invalid Switch </FieldLabel>
          <FieldDescription>
