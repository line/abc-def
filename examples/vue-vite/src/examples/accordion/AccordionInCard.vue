            ...
            <AccordionContent>
              ...
              <template v-else-if="item.value === 'billing'">
                ...
                <p>
                  ...
                  can update your payment method or billing information anytime
                  in your account settings. Failed payments will trigger
              ...
              <template v-else-if="item.value === 'cancel'">
                ...
                <p>
                  ...
                  after canceling. We'd love to hear your feedback about why
                  you're leaving.
                </p>
              </template>
              <template v-else-if="item.value === 'refund'">
                ...
                <p>
                  ...
                  Enterprise customers have custom refund terms outlined in
                  their contracts.
                </p>
              </template>
            </AccordionContent>
