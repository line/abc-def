...
const formPresetVariables = {
  ...
  lab: {
    ...
    "--input-fg-placeholder": "oklch(0.34 0.03 252)",
    "--textarea-bg": "oklch(0.98 0.01 250)",
    "--textarea-border": "oklch(0.74 0.04 250)",
    "--textarea-fg-placeholder": "oklch(0.5 0.03 250)",
    ...
    "--select-trigger-fg-placeholder": "oklch(0.46 0.04 252)",
    "--select-content-bg": "oklch(0.97 0.02 248)",
    "--select-content-border": "oklch(0.71 0.05 255)",
    "--select-item-bg-focus": "oklch(0.84 0.08 255)",
    "--select-item-fg-focus": "oklch(0.22 0.03 252)",
    "--checkbox-bg": "oklch(1 0 0)",
...
const interactionPresetVariables = {
  ...
  pulse: {
    ...
    "--select-trigger-fg-placeholder": "oklch(0.38 0.03 250)",
    "--select-content-bg": "oklch(0.97 0.02 250)",
    "--select-content-border": "oklch(0.78 0.04 255)",
    "--select-item-bg-focus": "oklch(0.83 0.08 254)",
    "--select-item-fg-focus": "oklch(0.2 0.03 255)",
  ...
  lagoon: {
    ...
    "--select-trigger-fg-placeholder": "oklch(0.36 0.04 188)",
    "--select-content-bg": "oklch(0.98 0.01 184)",
    "--select-content-border": "oklch(0.74 0.05 188)",
    "--select-item-bg-focus": "oklch(0.83 0.08 185)",
    "--select-item-fg-focus": "oklch(0.2 0.03 188)",
