...
import { Button } from "@line/abc-def-react/v2";
...
export const OnlyIcon = () => (
  <div className="grid grid-cols-[repeat(3,max-content)] gap-2">
    <Button size="small" variant="primary" iconOnly>
      <Icon name="RiFlashlightFill" />
    </Button>
    <Button size="medium" variant="primary" iconOnly>
      <Icon name="RiFlashlightFill" />
    </Button>
    <Button size="large" variant="primary" iconOnly>
      <Icon name="RiFlashlightFill" />
    </Button>
  </div>
);
