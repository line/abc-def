  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(
          "calendar-caption-label-default",
          captionLayout !== "label" && "calendar-caption-label-dropdown",
        ...
        day: cn(
          ...
          props.showWeekNumber && "calendar-day-show-week-number",
        ...
        today: cn(
          "rounded-(--cell-radius) bg-(--calendar-bg-muted) text-(--calendar-fg) data-[selected=true]:rounded-none",
